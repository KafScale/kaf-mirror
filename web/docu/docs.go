// Package docu Code generated by swaggo/swag. DO NOT EDIT
package docu
    ...
    "paths": {
        ...
        "/jobs/{id}/mirror/state": {
            "get": {
                ...
                "description": "Retrieve comprehensive mirror state information for a specific job including progress, resume points, and gaps.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Get comprehensive mirror state for a job",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Job ID",
